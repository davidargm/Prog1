...
public class Main {
	...
	public static void main(String[] args) {
		...
		fila = getFila();
		numero = getNumero();
		insertarNumero(matInt[fila], numero);
		imprimir_matriz_int(matInt);
	}
	
	public static void insertarNumero(int[]arrInt, int num){
		int pos = buscarPosicion(arrInt, num);
	...
	public static int buscarPosicion(int[]arrInt, int num){
		int pos = 0;
		while(pos<MAXCOLUMNA-1 && arrInt[pos]<num){
			pos++;
		}
		return pos;
	}
